...
const Sidebar = () => {
  return (
    <aside class=" sticky top-0 flex flex-col w-52 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        <a href="#">
            <h1 className=''>ZTO.MN</h1>
        </a>
            ...
            <nav class="-mx-3 space-y-6 ">
                ...
                <div class="space-y-3 ">
                    ...
                    <Link to='feature' >Feature</Link>
                        ...
                        {/* <span class="mx-2 text-sm font-medium">Feature</span> */}
                    </div>
